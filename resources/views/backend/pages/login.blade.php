                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="" class="noble-ui-logo d-block mb-2">Support<span> Ticket</span></a>
                                        @if(session('success'))
                                            <div class="popupRightBottom text-success  mt-1">
                                                {{ session('success') }}</div>
                                        @endif
                                        @if(session('error'))
                                            <div class="popupRightBottom text-danger  mt-1">
                                                {{ session('error') }}</div>
                                        @endif
